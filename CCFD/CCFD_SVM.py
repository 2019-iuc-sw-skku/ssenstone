...
class CCFDT:
    ...
    def training(self):
        ...
        pickle.dump(clf, open("./CCFD/models/model_svm" + str(self.model_set) + ".sav", "wb"))
        pickle.dump(sc, open("./CCFD/scalers/scaler_svm" + str(self.model_set) + ".sav", "wb"))
    ...
    def show_pickle(self):
        data_list = []
        with open("./model_svm" + str(self.model_set) + ".sav",'rb') as FL:
            data=[]
            while(True):
                try: 
                    data=pickle.load(FL)
